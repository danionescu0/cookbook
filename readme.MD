...
- **app_settings** — a single row (id=1), not a real multi-row table: supported_languages,
  ...
  provider"). Seeded once from `.env` by migration `0006`/`0007`/`0017`; editable live from the back office
